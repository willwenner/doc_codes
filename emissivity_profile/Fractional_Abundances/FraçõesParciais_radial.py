...
plt.ylabel(r'Coeficientes de taxa de recombinação CX  [\(m^3.s^-1\)]', fontsize=12)
plt.title('Coeficientes CX', fontsize=13)
plt.grid(True, which='both', linestyle='--', alpha=0.6)
plt.legend(fontsize=10)
plt.savefig("Coef_rec_CX.png")
plt.tight_layout()
...
plt.title(f'Perfil de temperatura toroidal (simulação simples)',fontsize=13)
plt.grid(True, which='both', linestyle='--', alpha=0.6)
plt.legend(fontsize = 10)
plt.savefig("PerfilToroidal.png")
plt.tight_layout()
...
plt.grid(True, which='both', linestyle='--', alpha=0.6)
plt.legend(fontsize = 10)
plt.savefig("Frac_Partial_radius.png")
plt.tight_layout()
